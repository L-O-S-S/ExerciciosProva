...
namespace Prova
{
    public partial class inserirFun : System.Web.UI.Page
    {
        ...
        protected void btnInserir_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = @"insert into funcionario (nom_fun, sex_fun, dtn_fun, num_crt_trab_fun, tel_fix_fun, tel_cel_fun, email_fun, log_end_fun, num_end_fun, bair_end_fun, cid_end_fun, uf_end_fun) 
                                    values (@nome, @sexo, @datNasc, @carteira, @tel_fixo, @tel_cel, @email, @log, @num, @bairro, @cidade, @uf);";
                ...
                cmd.Parameters.AddWithValue("tel_cel", txtTelCel.Text);
